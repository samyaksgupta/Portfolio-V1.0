...
! function(p, t) {
    ...
    y.Instance = function() {
        ...
        this.addElement = function(t, e, n) {
            ...
            var n, i, o;
            if (t instanceof y.Instance) return n = g.concat(c.getClosureMethods()), p.each(n, function() {
                var t = c[this];
                c[this] = function() {
                    t.apply(c, arguments)
                }
        ...
        activeKeyDown: function(t) {
            var e, n;
            this.focusedButton && 9 === t.which && (t.preventDefault(), e = this.focusedButton.index(), t.shiftKey ? (n = e - 1) < 0 && (n = this.buttons.length - 1) : (n = e + 1) >= this.buttons.length && (n = 0), this.focusedButton = this.buttons[n].trigger("focus"))
        },
        addButton: function(t) {
            function e() {
                i.hide.onButtonClick && n.hide(), "function" == typeof t.callback && t.callback.call(this, n)
            }
            var n = this,
                i = n.getSettings(),
