        ...
        m = (b.extend(v.prototype, e, {
            ...
            set: function(t, e, i) {
                if (null != t) {
                    ...
                    for (s in n) e = n[s], b.isEqual(l[s], e) || h.push(s), b.isEqual(u[s], e) ? delete c[s] : c[s] = e, o ? delete l[s] : l[s] = e;
                    if (this.idAttribute in n && (r = this.id, this.id = this.get(this.idAttribute), this.trigger("changeId", this, r, i)), !t) {
                        ...
                        for (var d = 0; d < h.length; d++) this.trigger("change:" + h[d], this, l[h[d]], i)
                    }
                    if (!a) {
                        if (!t)
