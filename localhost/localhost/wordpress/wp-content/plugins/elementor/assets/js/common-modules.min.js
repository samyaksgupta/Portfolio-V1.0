                ...
                function _objectSpread2(C) {
                    for (var T = 1; T < arguments.length; T++) {
                        ...
                        T % 2 ? ownKeys(Object(B), !0).forEach((function(T) {
                            var q, H, L;
                            q = C, H = T, L = B[T], (H = _toPropertyKey(H)) in q ? Object.defineProperty(q, H, {
                                value: L,
                                enumerable: !0,
                                configurable: !0,
                                writable: !0
                ...
                var createPause = function(C) {
                    ...
                    createFork = function(C, T) {
                        return function(B, q) {
                            ...
                            var H, L = new AbortController;
                            H = L, addAbortSignalListener(C, (function() {
                            ...
                            var V, $, U = (V = function() {
                                return __async(void 0, null, (function() {
                                    ...
                                    return __generator(this, (function(q) {
                                        switch (q.label) {
                                            case 0:
                                                return validateActive(C), validateActive(L.signal), [4, B({
                                                    pause: createPause(L.signal),
                                                    delay: createDelay(L.signal),
                                                    signal: L.signal
                                                })];
                                            case 1:
                                                return T = q.sent(), validateActive(L.signal), [2, T]
                                        }
                                    }))
                                }))
                            }, $ = function() {
                            ...
                            return __async(T, null, (function() {
                                ...
                                return __generator(this, (function(X) {
                                    switch (X.label) {
                                        ...
                                        case 1:
                                            return X.trys.push([1, 3, 4, 6]), C.pending.add(T), [4, Promise.resolve(C.effect(H, qe({}, V, {
                                                getOriginalState: $,
                                        ...
                                        case 2:
                                            return X.sent(), [3, 6];
                                        case 3:
                                            return (K = X.sent()) instanceof De || safelyNotifyError(L, K, {
                                                raisedBy: "effect"
                                            }), [3, 6];
                                        case 4:
